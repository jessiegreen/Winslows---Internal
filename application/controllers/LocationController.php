...
class LocationController extends Dataservice_Controller_Action
{    
    public function init(){
	$this->view->headScript()->appendFile("/javascript/location/location.js");
	parent::init();
    }
    
    public function viewAction()
    {
	$Location = $this->getEntityFromParamFields("Location", array("id"));
	...
	$form = new Form_Location(array("method" => "post"), $Location);
	...
	if($this->isPostAndValid($form)){
	    try 
	    {
		$location_data	= $this->_params["location"];
