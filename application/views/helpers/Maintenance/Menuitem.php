 ...
 */
class Zend_View_Helper_Maintenance_Menuitem//  extends Zend_View_Helper_Abstract
{
    public $view;
    ...
    public function Maintenance_Menuitem(\Entities\MenuItem $MenuItem)
    {
    ...
    private function render(\Entities\MenuItem $MenuItem){
	?>
