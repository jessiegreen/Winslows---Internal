 ...
 */
class TimeClock extends \Entities\Company\TimeClock implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addEntry(\Entities\Company\TimeClock\Entry $Entry)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'created', 'updated', 'Company', 'Entries');
    }
