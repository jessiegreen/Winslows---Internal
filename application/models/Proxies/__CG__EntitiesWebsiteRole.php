 ...
 */
class Role extends \Entities\Website\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function removeAccount(\Entities\Website\Account\AccountAbstract $Account)
    {
        $this->__load();
