 ...
 */
class MenuItem extends \Entities\MenuItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setParent(\Entities\MenuItem $parent)
    {
        $this->__load();
    ...
    public function AddChild(\Entities\MenuItem $child)
    {
        $this->__load();
    ...
    public function setMenu(\Entities\Menu $menu)
    {
        $this->__load();
