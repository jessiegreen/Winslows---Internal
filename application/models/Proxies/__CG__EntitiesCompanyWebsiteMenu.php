 ...
 */
class Menu extends \Entities\Company\Website\Menu implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addItem(\Entities\Company\Website\Menu\Item $Item)
    {
        $this->__load();
    ...
    public function removeItem(\Entities\Company\Website\Menu\Item $Item)
    {
        $this->__load();
