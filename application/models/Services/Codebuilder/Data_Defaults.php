...
class Data_Defaults //Creating this for default selection. Think about creating form options data too. Will make it easier when changing to ini or whatever. Easier to read too.
{   
