...
class Dataservice_Filter_ImageSize_Configuration_Standard implements Dataservice_Filter_ImageSize_Configuration_Interface 
{
    /**
     ...
     * @var string
     */
    protected $_overwriteMode = Dataservice_Filter_ImageSize::OVERWRITE_NONE;
    ...
    /**
     * Resizing strategy.
     * @var Dataservice_Filter_ImageSize_Strategy_Interface
     */
     ...
     * 
     * @return Dataservice_Filter_ImageSize_Strategy_Interface
     */
    public function getStrategy()
    {
        if (null === $this->_strategy) {
            $this->_strategy = new Dataservice_Filter_ImageSize_Strategy_Fit();
        }
     ...
     * @return Dataservice_Filter_ImageSize_Configuration_Interface Fluent interface
     */
     ...
     * 
     * @param Dataservice_Filter_ImageSize_Strategy_Interface $strategy
     * @return Dataservice_Filter_ImageSize_Configuration_Interface Fluent interface
     */
    public function setStrategy(Dataservice_Filter_ImageSize_Strategy_Interface $strategy)
    {
     ...
     * @return Dataservice_Filter_ImageSize Fluent interface
     */
