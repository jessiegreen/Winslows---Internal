 ...
 */
class Dataservice_Filter_ImageSize_PathBuilder_Standard implements Dataservice_Filter_ImageSize_PathBuilder_Interface
{
    /**
     ...
     * 
     * @param type $filename
     * @param Dataservice_Filter_ImageSize_Configuration_Interface $config
     * @return string
     */
    public function buildPath($filename, Dataservice_Filter_ImageSize_Configuration_Interface $config)
    {
