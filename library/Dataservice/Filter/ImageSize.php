...
/**
 * @see Dataservice_Filter_ImageSize_Strategy_Fit
 */
require_once 'Dataservice/Filter/ImageSize/Strategy/Fit.php';

/**
 * @see Dataservice_Filter_ImageSize_PathBuilder_Interface
 */
require_once 'Dataservice/Filter/ImageSize/PathBuilder/Interface.php';

/**
 * @see Dataservice_Filter_ImageSize_PathBuilder_Standard
 */
require_once 'Dataservice/Filter/ImageSize/PathBuilder/Standard.php';

/**
 * @see Dataservice_Filter_ImageSize_Configuration_Standard
 */
require_once 'Dataservice/Filter/ImageSize/Configuration/Standard.php';
 ...
 */
class Dataservice_Filter_ImageSize implements Zend_Filter_Interface
{
    /**
    ...
    /** @var Dataservice_Filter_ImageSize_PathBuilder_Interface */
    protected $_pathBuilder = null;

    /** @var Dataservice_Filter_ImageSize_Configuration_Interface */
     ...
     * Constructor.
     */
    public function __construct(Dataservice_Filter_ImageSize_Configuration_Interface $config = null)
    {
     ...
     * on first call.
     * 
     * @return Dataservice_Filter_ImageSize_Configuration_Interface
     */
    public function getConfig()
    {
        if (null === $this->_config) {
            $this->_config = new Dataservice_Filter_ImageSize_Configuration_Standard();
        }
        return $this->_config;
    }
     ...
     * configuration.
     * 
     * @param Dataservice_Filter_ImageSize_Configuration_Interface $configSet
     */
    public function setConfig(Dataservice_Filter_ImageSize_Configuration_Interface $config)
    {
        $this->_config = $config;
    }
    
    /**
     * Returns the Dataservice_Filter_ImageSize_PathBuilder_Interface instance
     * used to build the path of output files.
     * 
     * @return Dataservice_Filter_ImageSize_PathBuilder_Interface
     */
    public function getOutputPathBuilder()
    {
        if (null === $this->_pathBuilder) {
            $this->_pathBuilder = new Dataservice_Filter_ImageSize_PathBuilder_Standard('./');
        }
        return $this->_pathBuilder;
    }
    
    /**
     * Sets the Dataservice_Filter_ImageSize_PathBuilder_Interface instance used
     * to build the path of output files.
     * 
     * @param Dataservice_Filter_ImageSize_PathBuilder_Interface $pathBuilder
     * @return Dataservice_Filter_ImageSize
     */
    public function setOutputPathBuilder(Dataservice_Filter_ImageSize_PathBuilder_Interface $pathBuilder)
    {
    ...
    protected function _checkWritePermissions()
    {
        if ($this->getConfig()->getOverwriteMode() == self::OVERWRITE_NONE) {
            ...
            if (file_exists($outputPath)) {
                throw new Zend_Filter_Exception('Can\'t create thumbnail. File already exists: ' . $outputPath . '. Use $this->getConfig()->setOverrideMode(Dataservice_Filter_ImageSize::OVERWRITE_ALL) to allow overriding existing files.');
            }
        }
    }
